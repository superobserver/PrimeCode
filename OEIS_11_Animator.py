...
def analyze_blocks(lst, block_size=5000):
    ...
    create_stacked_panels_animation(
        [block_pairs, block_pairs, block_pairs, block_pairs, block_pairs],  # Use block_pairs for all
...
#    )
    create_single_grid_animation(
        block_pairs,
        [marks_increases, signal_to_zero_ratios],
        ["Marks Increase", "Signal-to-Zero Ratio", "Marks % Change", "Zeroes Change", "Zeroes % Change", "Signal-to-Zero Ratio"],
        "single_grid_animation.mp4"
    )
