...
def speak_text(text, filename=None, voice_gender='male'):
    ...
    Uses pyttsx3 direct speech, falls back to SAPI5 or gTTS.
    """
    if filename:
    ...
    # Fallback to SAPI5 via win32com
    if 'pywin32' not in missing_modules:
        try:
            speaker = win32com.client.Dispatch("SAPI.SpVoice")
            # Attempt to select voice
    ...
    print("All TTS engines failed. Please ensure pyttsx3, pywin32, or gtts is installed and audio drivers are active.")
    return False
