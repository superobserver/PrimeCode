...
def get_first_holes_with_factors(n_max, amplitude, coprime_24, limit=20):
...
if __name__ == '__main__':
    print("Computing First 20 Holes per Class with Primality Test")
    n_max = 1500  # Adjusted to ensure 20 holes per class
    ...
    # Get first 20 holes with primality test
    holes = get_first_holes_with_factors(n_max, amplitude, coprime_24, limit=20)
