...
if __name__ == '__main__':
    print("Computing NORMALIZED SUM OF RECIPROCALS zeta by DR subgroups with multiprocessing")
    n_max = 23900001  # Match your run
    s = 0.5 + 14.134725j
    dr_groups = {
        "DR_1": [19, 37, 91],
        "DR_2": [11, 29, 47, 83],
    ...
    for dr_name, k_values in dr_groups.items():
        ...
        normalized_total = total_zeta * (4 / 15)  # Normalize per full sum
        print(f"\n{dr_name}:")
        print(f"n_max={n_max}, Holes={total_holes}, Total sum={total_zeta}, Normalized sum={normalized_total}, |Normalized sum|={abs(normalized_total):.6f}")
    
    # Full sum for reference
