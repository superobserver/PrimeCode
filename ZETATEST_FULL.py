...
print("Computing NORMALIZED SUM OF RECIPROCALS zeta for ALL 24 classes")
n_max = 199900001
s = 0.5 + 14.134725j
total_zeta = 0
total_holes = 0
...
print(f"n_max={n_max}, Total Holes={total_holes}, Total sum of reciprocals={total_zeta}, Normalized (4/15) sum={normalized_total}, |Normalized sum|={abs(normalized_total):.6f}")