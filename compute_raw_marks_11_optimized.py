...
def approximate_raw_marks_11(n_end):
    """Approximate raw markings using refined formula."""
    return 0.1368 * n_end * math.log(n_end) if n_end > 1 else 0
...
if __name__ == "__main__":
    ...
    for n_end in n_end_values:
        ...
        print(f"n_end = {n_end}: Exact = {exact}, Approx = {approx:.0f}, Error = {100 * (exact - approx) / exact:.2f}%")