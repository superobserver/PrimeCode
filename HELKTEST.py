...
def drLD(x, l, m, z, o, listvar, primitive):   #x=increment, l=quadratic term, m = quadratic term, z = primitive, o = primitive
  ...
  try:
    ...
    print("This overfloweed list at x,z,o,y", x,z,o,y)
    pass    
  p = z+(90*(x-1))
  q = o+(90*(x-1))
...
# 19
    drLD(x, 70, -1, 19, 91, A201804, 19) #19,91
    drLD(x, 106, 31, 37, 37, A201804, 19) #37,73
    drLD(x, 34, 3, 73, 73, A201804, 19) #73,73
    drLD(x, 110, 27, 11, 59, A201804, 19) #11,59
    drLD(x, 110, 33, 29, 41, A201804, 19) #29,41
    drLD(x, 56, 6, 47, 77, A201804, 19) #47,77
    drLD(x, 74, 5, 23, 83, A201804, 19) #23,83
    drLD(x, 124, 40, 13, 43, A201804, 19) #13,43
    drLD(x, 70, 7, 31, 79, A201804, 19) #31,79
    drLD(x, 70, 13, 49, 61, A201804, 19) #49,61
    drLD(x, 106, 21, 7, 67, A201804, 19) #7,67
    drLD(x, 20, 0, 71, 89, A201804, 19) #71,89
    drLD(x, 74, 15, 53, 53, A201804, 19) #53,53
    drLD(x, 146, 59, 17, 17, A201804, 19) #17,17
