...
A201804_shared = multiprocessing.RawArray('i', array_size)  # Shared memory for A201804
marks_per_operator_shared = [multiprocessing.RawArray('i', array_size) for _ in range(12)]  # Shared memory for each operator
...
def process_operators(operator_indices, A201804_shared, marks_per_operator_shared, limit, new_limit, operator_params):
    # Convert shared arrays to numpy arrays for this process
...
def main():
    ...
    # Convert shared arrays back to numpy for final processing
