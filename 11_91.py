...
start =  9999999999999999999 #999999999999999999000
...
def drLD(x, l, m, z, o):   
  ...
  p = z+(90*(x-1))
  newp_start = int(((start-y)/p)-1)
  newp_lim = int(((limit-y)/p)+2)
  ...
  q = o+(90*(x-1))
  newq_start = int(((start-y)/q)-1)
  newq_lim = int(((limit-y)/q)+2)
...
with open('11_91.csv', 'w', newline='') as file:
