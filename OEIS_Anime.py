...
def analyze_blocks(lst, block_size=1000):
    """Analyze the list in blocks of block_size elements for marks and zeroes, and generate plots."""
    ...
    # Static combined plot (2x2 subplot)
    fig, axs = plt.subplots(2, 2, figsize=(12, 8))
    axs[0, 0].plot(block_pairs, marks_increases, marker='o')
    ...
    axs[0, 1].plot(block_pairs, marks_percent_changes, marker='o')
    ...
    axs[1, 0].plot(block_pairs, zeroes_changes, marker='o')
    ...
    axs[1, 1].plot(block_pairs, zeroes_percent_changes, marker='o')
    ...
    # Stacked panels animation (four panels, one for each metric)
    def create_stacked_panels_animation(x_values, y_values_list, titles, ylabels, filename):
        fig, axs = plt.subplots(4, 1, figsize=(10, 12), sharex=True)
        lines = []
        for i, (y_values, title, ylabel) in enumerate(zip(y_values_list, titles, ylabels)):
        ...
        axs[3].set_xticks(range(len(x_values)))
        axs[3].set_xticklabels(x_values, rotation=45)
    ...
    create_stacked_panels_animation(
        block_pairs,
        [marks_increases, marks_percent_changes, zeroes_changes, zeroes_percent_changes],
        ["Marks Increase", "Marks % Change", "Zeroes Change", "Zeroes % Change"],
        ["Marks Increase", "Marks % Change", "Zeroes Change", "Zeroes % Change"],
