...
start = 9999999999 #99999999999999999
#last working value = 99999999999999999#9999999999999999999 #input("start value here:")
print("Length of the start value (address)", len(str((start))))
print(7*12857142857142858083)

#Breaks consistency at 999999999999999999, code returns the leftmost address in base-10

#90000000000000006581 = 7*12857142857142858083
#90000000000000001361 = 53*1698113207547169837
#90000000000000002261 = PRIME
#90000000000000003251 = 13*6923076923076923327
#90000000000000003791 = PRIME
#90000000000000005951 = 7*12857142857142857993
#90000000000000006491 = PRIME
#90000000000000006581 = 7*12857142857142858083
#90000000000000007391 = 47*1914893617021276753
#90000000000000008201 = PRIME

#broken=9999999999999999999
start = int(start)
limit = start+100
limit = int(limit)
...
def update(frame):
    # Calculate the cycloid for the current frame
    x, y = cycloid(frame)
...
anim = FuncAnimation(fig, update, frames=np.linspace(0, 12*np.pi, len(numbers)), init_func=init)
