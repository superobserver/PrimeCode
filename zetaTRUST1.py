...
def compute_zeta_24(args):
    ...
    for k in k_values:
        ...
        k_primes = [90 * n + 1 if k == 91 else 90 * n + k for n in k_holes]
...
if __name__ == '__main__':
    ...
    n_max = 43900001  # Direct to 23.9M
    s = 0.5 + 14.134725j
    ...
    # Holes for k = 91
    amplitude_91 = amplitudes[91]
    holes_91_count = amplitude_91.count(0)
    print(f"\nHoles for k = 91: {holes_91_count}")
    holes_91 = [n for n in range(n_max + 1) if amplitude_91[n] == 0]
    base10_holes_91 = [90 * n + 1 for n in holes_91]
    print(f"\nBase-10 Equivalents (90n + 1) for Holes (k = 91):")
    print(f"First 15: {base10_holes_91[:15]}")
    print(f"Last 5: {base10_holes_91[-5:]}")
    print(f"Total Holes: {len(base10_holes_91)}")
    ...
    for k in coprime_24:
        ...
        k_primes = [90 * n + 1 if k == 91 else 90 * n + k for n in k_holes]
        print(f"k = {k}: {hole_count} primes, First 5: {k_primes[:5]}")
